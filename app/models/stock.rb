...
class Stock < ApplicationRecord
  ...
  def yearly_revenue_change
    @income_statements_yearly.first.revenue / @income_statements_yearly.second.revenue
  end

  def yearly_net_profit_change
    @income_statements_yearly.first.net_profit / @income_statements_yearly.second.net_profit
  end
